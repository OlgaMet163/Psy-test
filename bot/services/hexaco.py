...
STATEMENTS: List[Statement] = [
    Statement(
        1,
        "Как часто вы сразу озвучиваете свои реальные приоритеты в совместной работе?",
    ),
    Statement(
        2,
    ...
    Statement(
        6,
        "Если вы подготовили план действий, как часто вам нужно снова прокручивать его в голове?",
    ),
    Statement(
        7,
        "Насколько сильно на вас влияют эмоциональные подъёмы и спады ваших коллег?",
    ),
    Statement(
        8,
    ...
    Statement(
        11,
        "Как часто в вашем голосе отражается текущее настроение (энтузиазм, радость, грусть и т.д.)?",
    ),
    Statement(
        12,
    ...
    Statement(
        20,
        "Как часто вам нужна срочность (дедлайн/давление), чтобы завершить работу?",
    ),
    Statement(
        21,
